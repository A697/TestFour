...
public class BackgroundTask extends AsyncTask<String,Void,String> {
    ...
    protected String doInBackground(String... params) {
        ...
        String urlRegistration = "https://developersociety.in/hospital/Doctor/Test3/Insert.php";
        String urlLogin  = "https://developersociety.in/hospital/Doctor/Test3/Login.php";
